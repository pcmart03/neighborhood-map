var model = {
  ...
  {
    name: "Ristorante La Perla of Washington",
    phone: 2023331767,
    lat: 38.904063,
    lng: -77.055062,
    highlight: ko.observable(null)
...
var viewModel = function(){
  ...
  self.yelpObjects = ko.observableArray();
	...
	// subscriptions to activate and deactivate the highlight.
...
//Initializes the google map
	var drawMap = function() {
		if(typeof window.google === 'object' && typeof window.google.maps === 'object') {
	      ...
	      var marker = new google.maps.Marker({
			...
			$('#map-canvas').html("<h3>Google Map Failed to Load</h3>");
		}
	}(); //end drawMap
	...
	//link to the icon representing the current weather from the openweathermap
